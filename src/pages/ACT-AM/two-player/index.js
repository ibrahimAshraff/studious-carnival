    ...
    return (
        <div className="App">
            ...
            {inputState ?
                ...
                <>
                    <div className="form" style={{ margin: "100px auto" }}>
                        <div className="title">Welcome</div>
                        <div className="subtitle">Let's create your team names!</div>
                        <div className="input-container ic1">
                            <input id="team A"
                                className="input" type="text"
                                value={challengers}
                                onChange={(e) => setChallengers(e.target.value)}
                                placeholder=" " />
                            <div className="cut"></div>
                            <label htmlFor="team A" className="placeholder">Challengers</label>
                        </div>
                        <div className="input-container ic2">
                            ...
                            />
                            <div className="cut"></div>
                            <label htmlFor="team B" className="placeholder">Defenders</label>
                        </div>

                        <button
                            type="text"
                            className="submit"
                            disabled={challengers.length < 1 && defenders.length < 1}
                            onClick={() => SetInputstate(false)}>submit</button>
                    </div>
                </> :

                <>
                    {/* <h1 style={{ margin: "20px auto", textAlign: "center" }}>Game {score}</h1> */}

                    <h2 style={{ margin: "20px auto", textAlign: "center" }}>{challengers}: {score}</h2>
                    <h2 style={{ margin: "20px auto", textAlign: "center" }}>{defenders} : {score}</h2>
